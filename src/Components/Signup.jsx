...
export default function Signup() {
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center px-4 py-12 bg-neoWhite dark:bg-neoDark relative overflow-hidden">
      ...
      <div className="absolute top-20 right-20 w-20 h-20 bg-gGreen border-4 border-neoBlack shadow-neo rounded-none transform rotate-45 hidden md:block"></div>
      <div className="absolute bottom-20 left-20 w-16 h-16 bg-gRed border-4 border-neoBlack shadow-neo rounded-full animate-pulse hidden md:block"></div>
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-white dark:bg-neoDark border-4 border-neoBlack dark:border-neoWhite shadow-neo-lg p-8 transform -rotate-1 hover:rotate-0 transition-transform duration-300">
          ...
          <div className="text-center mb-8">
            <h2 className="text-4xl font-black text-gRed mb-2 tracking-tighter">JOIN THE FORCE</h2>
            <p className="text-neoBlack dark:text-neoWhite font-bold">Create your DisasterWatch account</p>
          </div>
          ...
          <form onSubmit={onSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-lg font-black text-neoBlack dark:text-neoWhite uppercase">Full Name</label>
              <input
                name="name"
                type="text"
                required
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-4 px-4 bg-gBlue text-white font-black text-xl border-2 border-neoBlack shadow-neo hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none transition-all disabled:opacity-70 disabled:cursor-not-allowed disabled:shadow-none disabled:translate-x-[2px] disabled:translate-y-[2px]"
            >
          ...
          <div className="mt-8 text-center text-sm font-bold text-neoBlack dark:text-neoWhite">
            ...
            <Link to="/login" className="text-gBlue hover:underline decoration-2 underline-offset-2">
              Sign in
            </Link>
          </div>
        </div>
